...
//  StickyHeader
//
//  Created by 外間麻友美 on 2018/12/20.
//  Copyright © 2018 外間麻友美. All rights reserved.
//

import UIKit

class StickyHeader: NSObject {

    private(set) lazy var contentView: HeaderContainerView = {
    ...
    private func updateConstraints() {
        ...
        self.contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|[v]|", options: [], metrics: nil, views: ["v": view]))
